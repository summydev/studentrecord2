...
SECRET_KEY = 'django-insecure-4-(v@u=dm9g6x)!yg!v1(s%dv71nouo3u*sogq^$+tpi13*i5)'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Moved to exactly here!
...
# Add this anywhere near the bottom of settings.py
REST_FRAMEWORK = {
